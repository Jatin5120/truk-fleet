...
class MoreTrukDetails extends StatefulWidget {
  final String trukNumber;
  MoreTrukDetails({this.trukNumber});
  @override
  _MoreTrukDetailsState createState() => _MoreTrukDetailsState();
}

class _MoreTrukDetailsState extends State<MoreTrukDetails> {
  bool insuranceDocumentStatus = false;
  bool fitnessCertificateStatus = false;
  ...
  Map<String, dynamic> documentStatus = {
    ...
    TrukDocumentType.fitness: [false, 'na'],
    TrukDocumentType.insurance: [false, 'na'],
  };
  Locale locale;
